      ...
      schema: {
        ...
        querystring: {
          ...
          properties: {
            ...
            isActive: { type: "string", description: "Perfil ativo (true/false)" },
            isVerified: {
              type: "string",
  ...
  fastify.get(
    "/top-rated",
    {
      schema: {
        ...
        description: "Retorna os perfis com melhor avaliação (mínimo 5 reviews)",
        querystring: {
          type: "object",
          properties: {
  ...
  fastify.post(
    "/",
    {
      ...
      schema: {
        ...
        description: "Cria um novo perfil profissional (apenas para PROFESSIONAL)",
        body: {
          type: "object",
