/**
 * Testes de integração completos para Reviews
...
describe("Review All Status Tests", () => {
  ...
  beforeAll(async () => {
    ...
    await app.register(
      async function (fastify) {
        ...
        // GET /professional/:professionalId - Reviews do profissional
        fastify.get(
        ...
        // GET /average-rating/:professionalId - Rating médio
        fastify.get(
          "/average-rating/:professionalId",
          {
            schema: {
              params: {
                type: "object",
  ...
  describe("Status 401 - Unauthorized", () => {
    it("deve retornar 401 para todas as rotas quando não autenticado", async () => {
      const routes = [
        ...
        {
          method: "GET",
          url: "/test/average-rating/123e4567-e89b-12d3-a456-426614174000",
        },
      ];
  ...
  describe("Status 400 - Bad Request", () => {
    ...
    it("deve retornar 400 para parâmetros de rota inválidos", async () => {
      const invalidParamTests = [
        ...
        { method: "GET", url: "/test/average-rating/invalid-uuid" },
      ];
  ...
  describe("Status 200 - OK (Success Scenarios)", () => {
    ...
    it("deve retornar 200 para GET /test/professional/:id (reviews do profissional)", async () => {
      const response = await app.inject({
        method: "GET",
        url: "/test/professional/123e4567-e89b-12d3-a456-426614174000",
        headers: { authorization: "Bearer valid-token" },
    ...
    it("deve retornar 200 para GET /test/average-rating/:id (rating médio)", async () => {
      const response = await app.inject({
        method: "GET",
        url: "/test/average-rating/123e4567-e89b-12d3-a456-426614174000",
        headers: { authorization: "Bearer valid-token" },
