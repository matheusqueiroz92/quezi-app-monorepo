...
export async function companyEmployeeRoutes(
  ...
  const companyEmployeeRepository =
    new (require("../../infrastructure/repositories/company-employee.repository").CompanyEmployeeRepository)(
      prisma
    );
  const service = new CompanyEmployeeService(companyEmployeeRepository);
