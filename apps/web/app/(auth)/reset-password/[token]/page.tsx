...
export default function ResetPasswordPage() {
  ...
  const onSubmit = async (data: ResetPasswordInput) => {
    ...
    try {
      await post(`/auth/reset-password/${token}`, {
          ...
          <div className="bg-white rounded-quezi-lg shadow-xl p-8 text-center animate-in fade-in-50 zoom-in-95 duration-500">
            ...
            <div className="animate-pulse">
              <div className="w-full h-1 bg-neutral-pearl rounded-full overflow-hidden">
                <div className="h-full bg-marsala rounded-full animate-[loading_2s_ease-in-out]"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-quezi-lg shadow-xl p-8 animate-in fade-in-50 slide-in-from-bottom-4 duration-500">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2 mt-3 p-3 bg-neutral-pearl/50 rounded-quezi">
                <p className="text-xs text-neutral-graphite font-semibold mb-2">
                  Requisitos da senha:
                </p>
                ...
                {password && (
                  <div className="mt-3">
                    <div className="flex items-center gap-2">
                      <div className="flex-1 h-2 bg-neutral-medium rounded-full overflow-hidden">
                        <div
            ...
            <Button
              ...
              className="w-full h-12 bg-marsala hover:bg-marsala-dark text-white font-semibold rounded-quezi shadow-md hover:shadow-lg transition-all disabled:opacity-50"
            >
...
// Componente auxiliar para items de validação
